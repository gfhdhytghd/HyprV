...
ShellRoot {
    ...
    component TrayButton: Item {
        ...
        MouseArea {
            ...
            onClicked: function(mouse) {
                ...
                } else if (mouse.button === Qt.RightButton && trayButton.trayItem.hasMenu) {
                    root.openTrayMenu(trayButton.trayItem, trayButton, trayButton.parentWindow);
                }
            }
    ...
    function openTrayMenu(item, sourceItem, parentWindow) {
        ...
        const point = sourceItem.mapToItem(parentWindow, Math.round(sourceItem.width / 2), sourceItem.height);
