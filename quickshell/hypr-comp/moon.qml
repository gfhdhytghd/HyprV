    ...
    Rectangle {
        ...
        Shape {
            ...
            ShapePath {
                ...
                startX: orbitCurvePath.width / 2 - (380 * root.zoomFactor)
                startY: orbitCurvePath.height / 2 + (120 * root.zoomFactor)

                PathArc {
                    x: orbitCurvePath.width / 2 - (380 * root.zoomFactor)
                    y: orbitCurvePath.height / 2 + (120 * root.zoomFactor)
        ...
        Rectangle {
            ...
            Item {
                ...
                Image {
                    ...
                    source: Qt.resolvedUrl("earth.jpg")
            ...
            Rectangle {
                ...
                Item {
                    ...
                    Image {
                        ...
                        source: Qt.resolvedUrl("moon.jpg")
                        fillMode: Image.Stretch; smooth: true; asynchronous: true
                    }
                    Image {
                        width: parent.width * 2; height: parent.height * 2
                ...
                Rectangle {
                    ...
                    Column {
                        ...
                        Image {
                            anchors.horizontalCenter: parent.horizontalCenter
                            width: 18; height: 18
                            source: Qt.resolvedUrl("hyprland.png")
