#!/usr/bin/env bash
export QS_CACHE_DIR="${QS_CACHE_DIR:-$HOME/.cache/hyprv/hypr-comp}"
export QS_STATE_DIR="${QS_STATE_DIR:-$HOME/.local/state/hyprv/hypr-comp}"
export QS_RUN_DIR="${QS_RUN_DIR:-${XDG_RUNTIME_DIR:-/tmp}/hyprv-hypr-comp}"
